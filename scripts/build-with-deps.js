 ...
 * 
 * 示例:
 *   node scripts/build-with-deps.js @sikao-engine/kimix-vscode-ext
 *   node scripts/build-with-deps.js @sikao-engine/kimix-vscode-ext buildCI
 */
...
function main() {
  ...
  if (args.length === 0) {
    ...
    console.error('\nExamples:');
    console.error('  node scripts/build-with-deps.js @sikao-engine/kimix-vscode-ext');
    process.exit(1);
  }
